...
namespace SangueHeroiWeb.Helpers.Util_Helper
{
    public class EmailHelper
    {
        ...
        public static bool EnviaEmailParaHemocentroPerfilAtivo(HemocentroModel model, bool priority)
        {
            bool emailOk = true;
            ...
            try
            {
                ...
                MailMessage = new MailMessage();
                MailMessage.From = new MailAddress("sangue.heroi@gmail.com", "Sangue Heroi", Encoding.UTF8);
                MailMessage.To.Add(new MailAddress(model.EMAIL_HEMOCENTRO, model.NOME_HEMOCENTRO, Encoding.UTF8));

                MailMessage.Subject = "Sangue Heroi - Solicitação de Parceria";
                MailMessage.Body = "Atenção! Seu Cadastro Foi Ativado com sucesso, foi gerado um login e senha automaticos, recomendamos que a senha seja alterada" +
                                   Environment.NewLine + "Login: " + model.LOGIN_HEMOCENTRO +
                                   Environment.NewLine + "Senha: " + model.SENHA_HEMOCENTRO;
                MailMessage.BodyEncoding = Encoding.UTF8;
                MailMessage.BodyEncoding = Encoding.GetEncoding("ISO-8859-1");
